...
-- ANA/JALは実はMarriott Bonvoyの提携移行先(3pt=1マイル、6万ptごとに+5000マイル)。要出典: bonvoy_partners.json/award_charts.json (2026-08-30調査)
INSERT INTO programs (code,name_ja,name_en,alliance,pricing_type,can_book_jal,can_book_ana,bonvoy_partner,bonvoy_ratio,bonvoy_bonus_block,bonvoy_bonus_miles,infant_rule,infant_pct,infant_notes_ja,infant_confidence,chart_confidence,notes_ja,sources) VALUES

('ANA','ANAマイレージクラブ','ANA Mileage Club','star','region_pair',0,1,1,3,60000,5000,
...
('JAL','JALマイレージバンク','JAL Mileage Bank','oneworld','distance_band',1,0,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('AS','アラスカ航空 マイレージプラン(Atmos Rewards)','Alaska Airlines Mileage Plan','oneworld','region_pair',1,0,1,3,60000,5000,
...
('BA','ブリティッシュ・エアウェイズ エグゼクティブクラブ(Avios)','British Airways Executive Club','oneworld','distance_band',1,0,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('VS','ヴァージン・アトランティック フライングクラブ','Virgin Atlantic Flying Club','skyteam','region_pair',0,1,1,3,60000,5000,
 'reduced_percentage',0.10,
 '2歳未満のラップ幼児は大人予約の約10%のVirgin Pointsで追加可能(税金等別途)。',
 'medium','medium',
 '2023年にSkyTeam加盟したが、ANA運航便(日本-北米)を予約できる独自の2社間提携は継続。ANAの777ビジネス「ザ・ルーム」を片道52,500〜60,000ポイントで予約できる有名なスイートスポット(2024年5月改定後の価格)。',
 'PrinceOfTravel/OneMileAtATime/ThriftyTraveler(2025-2026調査)。can_book_ana=trueはANA-Virgin間の2社間提携に基づく(アライアンス上の推定を上書き)'),

('AFKL','エールフランスKLM フライングブルー','Air France-KLM Flying Blue','skyteam','dynamic',0,0,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('KE','大韓航空 SKYPASS','Korean Air SKYPASS','skyteam','distance_band',0,0,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('SQ','シンガポール航空 クリスフライヤー','Singapore Airlines KrisFlyer','star','region_pair',0,1,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('CX','キャセイパシフィック航空 アジアマイル','Cathay Pacific Asia Miles','oneworld','distance_band',1,0,1,3,60000,5000,
...
('TK','ターキッシュ エアラインズ マイル・アンド・スマイルズ','Turkish Airlines Miles&Smiles','star','region_pair',0,1,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('AA','アメリカン航空 アドバンテージ','American Airlines AAdvantage','oneworld','dynamic',1,0,1,3,NULL,NULL,
...
('UA','ユナイテッド航空 マイレージプラス','United MileagePlus','star','dynamic',0,1,1,3,60000,10000,
 'varies',NULL,
...
('DL','デルタ航空 スカイマイル','Delta SkyMiles','skyteam','dynamic',0,0,1,3,NULL,NULL,
 'varies',NULL,
...
('EY','エティハド航空 エティハドゲスト','Etihad Guest','none','region_pair',0,0,1,3,60000,5000,
 'reduced_percentage',0.10,
...
('QR','カタール航空 プリビレッジクラブ(Avios)','Qatar Airways Privilege Club','oneworld','distance_band',1,0,1,3,60000,5000,
 'reduced_percentage',0.10,
